...
a=q(a,b);b=document.createElement("div");b.innerHTML=a;b=b.firstChild;b.setAttribute("data-choice",b.textContent);return b}function w(a){var b=this._wrapper.querySelector("."+(this._options.namingPrefix+"editableDiv")),c=document.getSelection(),d=this._currentActivator;if(c.focusNode==b||3==c.focusNode.nodeType)d=s.call(this,this._stackActivator,a,d),a=document.createTextNode("\u00a0"),c.getRangeAt(0).insertNode(a),c.getRangeAt(0).insertNode(d),d=document.createRange(),d.setStart(a,1),d.collapse(!0),
c.removeAllRanges(),c.addRange(d);g.call(this,this._modes.normal);k.call(this,!1);r.call(this,this._options.useText?b.textContent:b.innerHTML)}function x(a){var b=this;/loading/.test(this._wrapper.className)||(this._wrapper.className+=" "+(this._options.namingPrefix+"loading"));a.call(this,this._currentActivator,this._stack,this._options,function(a){var d=b._currentActivator;b._sourceResult=a;C.call(b);if("object"==typeof a&&a instanceof Array){var e=b._wrapper.querySelector("ul."+n.call(b,"choices"));
if(0<a.length)for(var f=0;f<a.length;f++){var y=a[f],g=document.createElement("li"),k=q(d.templates.suggestion,y),l=document.createElement("div");l.innerHTML=k;var m=l.firstChild;(function(a){m.onclick=function(){v.call(b);w.call(b,a)}})(y);g.appendChild(m);e.appendChild(g)}else g=document.createElement("li"),a=document.createElement("span"),a.className=n.call(b,"empty"),a.textContent="No result",g.appendChild(a),e.appendChild(g)}else h.call(b,"Source returned bad data type.");b._wrapper.className=
b._wrapper.className.replace(RegExp(n.call(b,"loading")),"").trim()})}function k(a){a=!!a;var b=this._wrapper;b.className=b.className.replace(/otobox-active/gi,"").trim();!0===a&&(b.className+=" otobox-active")}function g(a){if(a==this._modes.normal){this._stackActivator=this._stack="";this._currentMode=this._modes.normal;if(null!=this._currentActivator)if(this._currentActivator.customChoice){if(a=this._wrapper.querySelector("."+(this._options.namingPrefix+"editableDiv")).querySelector("."+(this._options.namingPrefix+
"hint")),null!=a){var b=m.call(this,a.textContent),b=s.call(this,b.activatorKey,{otobox_value:b.hintText},b.activator);a.parentNode.insertBefore(b,a);a.parentNode.removeChild(a)}}else if(a=this._wrapper.querySelector("."+(this._options.namingPrefix+"editableDiv")).querySelector("."+(this._options.namingPrefix+"hint")),null!=a){b=document.createTextNode(a.textContent);a.parentNode.insertBefore(b,a);a.parentNode.removeChild(a);var c=document.getSelection(),d=document.createRange();d.setStart(b,a.textContent.length);
c.removeAllRanges();c.addRange(d)}this._currentActivator=null}else a==this._modes.insert&&(this._stackActivator=this._stack="",this._currentMode=this._modes.insert)}function r(a){var b=this._targetObject;"undefined"!=typeof b.value?b.value=a:b.textContent=a}function m(a){if(0<this._activators.length){var b=a[0];a=a.substr(1,a.length-1);for(var c=0;c<this._activators.length;c++){var d=this._activators[c];if(d.key.test(b)&&d.allowedChars.test(a))return{activator:d,activatorKey:b,hintText:a}}}return null}
function z(a,b){var c=document.createElement("span");c.className=this._options.namingPrefix+"hint";c.setAttribute("data-activator",b.name);c.textContent=a;var d=document.getSelection();d.getRangeAt(0).insertNode(c);var e=document.createRange();e.setStart(c,1);d.removeAllRanges();d.addRange(e);return c}function D(a){if(this._currentMode==this._modes.normal){var b=this._wrapper.querySelector("."+(this._options.namingPrefix+"editableDiv"));a=document.getSelection().getRangeAt(0);if(a.startContainer.parentNode!=
...
a.textContent.replace(this._stackActivator+this._stack,"")))}}function E(a){var b;a:{b=String.fromCharCode(a.which);if(0<this._activators.length)for(var c=0;c<this._activators.length;c++){var d=this._activators[c];if(t.call(this,d).test(b)){b=d;break a}}b=null}c=document.getSelection().focusNode;this._currentMode==this._modes.normal&&null!=b&&/\s/.test(c.textContent[document.getSelection().focusOffset-1])?(g.call(this,this._modes.insert),this._currentActivator=b,this._stackActivator=String.fromCharCode(a.which),
z.call(this,String.fromCharCode(a.which),b),a.preventDefault()):this._currentMode==this._modes.insert&&/hint/.test(c.parentNode.className)&&(this._currentActivator.allowedChars.test(String.fromCharCode(a.which))?(this._stack+=String.fromCharCode(a.which),a=u.call(this),x.call(this,a),k.call(this,!0)):(g.call(this,this._modes.normal),k.call(this,!1)))}function F(a){var b=document.getSelection().focusNode,c=!1;if(this._currentMode==this._modes.normal&&null!=b&&b.parentNode.hasAttribute("data-choice")){b=
b.parentNode;if(/\s/.test(String.fromCharCode(a.which))){a=document.getSelection();var d=a.getRangeAt(0).startOffset,e="";b.textContent.length==d?e="\u00a0":(e=b.textContent.substr(0,d).trim(),d=b.textContent.substr(d,b.textContent.length),c=!0,b.textContent=e,e="\u00a0"+d);d=document.createTextNode(e);b.parentNode.insertBefore(d,b.nextSibling);e=document.createRange();e.setStart(d,1);e.collapse(!0);a.removeAllRanges();a.addRange(e);b.textContent=b.textContent.trim()}if(l.call(this,b.getAttribute("data-activator")).customChoice)c=
m.call(this,b.textContent),null!=c&&b.setAttribute("data-value",c.hintText);else if(b.getAttribute("data-choice")!=b.textContent){var f=document.getSelection(),d=f.getRangeAt(0).startOffset,e=document.createRange();a=document.createTextNode(b.textContent);b.parentNode.insertBefore(a,b);b.parentNode.removeChild(b);c||(e.setStart(a,d),e.collapse(!0),f.removeAllRanges(),f.addRange(e))}}c=this._wrapper.querySelectorAll("*[data-choice]");for(b=0;b<c.length;b++)d=c[b],m.call(this,d.textContent)||(a=document.createTextNode(d.textContent),
