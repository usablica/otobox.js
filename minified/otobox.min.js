...
c.onkeypress=function(a){F.call(b,a);G.call(b,a)};c.onkeydown=function(a){38==a.keyCode&&B.call(b,a,!0);40==a.keyCode&&B.call(b,a,!1);if(13==a.keyCode){if(b._currentMode==b._modes.insert){var c=b._wrapper.querySelector("li."+m.call(b,"active")+" a"),c=L.call(b,c.getAttribute("data-value"),b._currentActivator);x.call(b);y.call(b,c);a.preventDefault();return!1}if("input"==b._targetObject.nodeName.toLowerCase())return a.preventDefault(),!1}C.call(b,"update",[b,a])};c.onkeyup=function(a){H.call(b,a);
t.call(b,b._options.useText?c.textContent:c.innerHTML);if(46==a.keyCode||8==a.keyCode)K.call(b),J.call(b),I.call(b);if(37==a.keyCode||39==a.keyCode)l.call(b,b._modes.normal),g.call(b,!1);32==a.keyCode&&(l.call(b,b._modes.normal),g.call(b,!1));27==a.keyCode&&(l.call(b,b._modes.normal),g.call(b,!1),a.stopPropagation(),a.preventDefault())}}function k(a){throw Error("otobox - "+a);}function s(a,b){return a.replace(/{{(\w+)}}/g,function(a,d){return"undefined"!=typeof b[d]?b[d]:a})}function D(a,b){for(var c=
