...
"undefined"==typeof a[e]&&(a[e]=[]);a[e].push(d.getAttribute("data-value"))}return a},bind:function(a,b){"undefined"==typeof this._events[a]&&(this._events[a]=[]);this._events[a].push(b);return this},setContent:function(a){this._wrapper.querySelector("."+(this._options.namingPrefix+"editableDiv")).innerHTML=a;return this},trigger:function(a,b){D.call(this,a,b);return this},arraySource:function(a,b,c,d){c=[];for(var e=0;e<a.source.length;e++){var f=a.source[e];if(RegExp(b,"gi").test(f)){var g={};g.value=
