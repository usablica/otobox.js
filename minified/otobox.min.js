...
a.allowedChars||/.+/,a.tempKey=a.key,a.key=u.call(this,a),a.customChoice=!!a.customChoice,a.valueKey=a.valueKey||this._options.valueKey,"object"==typeof a.templates?("undefined"==typeof a.templates.suggestion&&(a.templates.suggestion=this._options.templates.suggestion),"undefined"==typeof a.templates.noResult&&(a.templates.noResult=this._options.templates.noResult),"undefined"==typeof a.templates.choice&&(a.templates.choice=this._options.templates.choice)):a.templates=this._options.templates,this._activators.push(a)):
h.call(this,"Name, key and source fields are mandatory for activator object."):h.call(this,"Activator object is empty.");return this},addChoice:function(a,b){var c=this._wrapper.querySelector("."+(this._options.namingPrefix+"editableDiv")),d=k.call(this,a),d=s.call(this,d.tempKey,b,d);c.appendChild(d);return this},getChoices:function(){for(var a={},b=this._wrapper.querySelectorAll("."+(this._options.namingPrefix+"editableDiv")+" *[data-choice]"),c=0;c<b.length;c++){var d=b[c],e=d.getAttribute("data-activator");
"undefined"==typeof a[e]&&(a[e]=[]);a[e].push(d.getAttribute("data-value"))}return a},bind:function(a,b){"undefined"==typeof this._events[a]&&(this._events[a]=[]);this._events[a].push(b);return this},trigger:function(a,b){D.call(this,a,b);return this},arraySource:function(a,b,c,d){c=[];for(var e=0;e<a.source.length;e++){var f=a.source[e];if(RegExp(b,"gi").test(f)){var g={};g.value=f;g.display=f;c.push(g)}}d.call(this,E.call(this,c,a))},xhrSource:function(a,b,c,d){var e=this,f=new XMLHttpRequest;f.open("GET",
q(a.source,{keyword:b}),!0);f.onreadystatechange=function(){if(4==f.readyState&&200==f.status){var b=JSON.parse(f.responseText);"function"==typeof a.postFetch&&(b=a.postFetch.call(e,b));d.call(e,E.call(e,b,a))}};f.send()}};return p});
